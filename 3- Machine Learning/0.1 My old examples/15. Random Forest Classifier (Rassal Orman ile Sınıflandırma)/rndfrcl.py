...
#DecisionTreeClassifier
    #sayısal karar ağacı yönteminin sınıflandırma versiyonudur.
    #gini ile kriterleme yöntemi mevcuttur.(başarıyı değiştirir.)
...
#RandomForestClassifier
    #estimators > uygulanan karar ağacı ile sınıflandırma yöntemidir
    #criterion gini olarak değiştirilebilir (bu tabloda başarı oranı gini>entropy)
...
y_proba=rfc.predict_proba(X_test) #doğru olma ihtimalleri,satır seçme şansımız vardır
