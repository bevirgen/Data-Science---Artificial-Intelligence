...
sc1=StandardScaler()
sc2=StandardScaler()
edscat=sc1.fit_transform(Edlv)
slscat=sc2.fit_transform(Slry)

from sklearn.svm import SVR
svr=SVR(kernel="rbf")
svr.fit(edscat,slscat)

plt.scatter(edscat,slscat,color="red")
plt.plot(edscat,svr.predict(edscat),color="blue")
