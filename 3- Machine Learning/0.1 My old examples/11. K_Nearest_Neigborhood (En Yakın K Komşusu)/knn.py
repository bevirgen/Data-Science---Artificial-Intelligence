...
#KNN
    #komşuluk ilişkisine göre tahmin
    #komşuluk derecesi çok önemlidir, bazen derece düşünce verim artar.
    #derece 5 iken 8de1 doğru tahmin, derece 1 iken 8de5
...
print("komşuluk derecesi 1 iken")
print(cm)
